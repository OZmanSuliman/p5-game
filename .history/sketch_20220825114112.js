...
function keyPressed() {
    if (isGameEnded) {
        ...
        if (keyCode == "39") {
            ...
            isLeft = true;
        } else if (keyCode == "32" && floorPos_y == gameChar_y) {
            isPlummeting = true;
            jumpSound.play();
        }
    }
...
function drawGameChar() {
            ...
            sleep(200).then(function () {
                for (let index = 0; index < platforms.length; index++) {
                    ...
                    if (isContact) {
                        ...
                        StepedDown = 0;
                        break;
                    } else if (gameCh ar_y - floorPos_y == 0) {
                stepsDown++;
                isFalling = true;
                gameChar_y += 100 / gravity;
                StepedDown++;
    ...
    StepedDown = 0;
        ...
        // if ((floorPos_y != gameChar_y) && !isPlummeting && stepsDown < gravity && !isOverCanyon && isContact) {
